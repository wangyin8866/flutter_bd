package com.koubeigongzuo.library.widget.xtablayout;
...
public class XTabLayout extends HorizontalScrollView {
   ...
   /*     TypedArray a = appContext.obtainStyledAttributes(attrs, android.support.design.R.styleable.TabLayout,
        ...
        mTabPaddingBottom = a.getDimensionPixelSize(R.styleable.XTabLayout_xTabPaddingBottom,
                mTabPaddingBottom);
        mIndicatorCornerRadius = a.getDimensionPixelSize(R.styleable.XTabLayout_xTabIndicatorCornerRadius, mIndicatorCornerRadius);
        ...
        public TabView(Context context) {
          ...
          /*  if (mTabBackgroundResId != 0) {
                setBackgroundDrawable(
                        AppCompatDrawableManager.get().getDrawable(appContext, mTabBackgroundResId));
            }*/
        ...
        public void draw(Canvas canvas) {
            ...
            if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
               ...
               /* int maxWidth = mIndicatorRight - mIndicatorLeft;
                ...
                RectF oval3 = new RectF(mIndicatorLeft, getHeight() - mSelectedIndicatorHeight,
                        mIndicatorRight, getHeight());
                mSelectedIndicatorPaint.setAntiAlias(true);
                canvas.drawRoundRect(oval3, mIndicatorCornerRadius, mIndicatorCornerRadius, mSelectedIndicatorPaint);
            }
        }
    }
