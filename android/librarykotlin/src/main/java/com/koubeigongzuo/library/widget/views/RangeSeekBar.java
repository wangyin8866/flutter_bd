    ...
    private class SeekBar {
        ...
        void onSizeChanged(int centerX, int centerY, int hSize, int parentLineWidth, boolean cellsMode, int bmpResId, Context context) {
            ...
            if (bmpResId > 0) {
                ...
                int mShadowCenterX = widthSize;
                int mShadowCenterY = heightSize;
                shadowGradient = new RadialGradient(mShadowCenterX, mShadowCenterY, barShadowRadius, Color.WHITE, Color.WHITE, Shader.TileMode.CLAMP);
            }
        }
